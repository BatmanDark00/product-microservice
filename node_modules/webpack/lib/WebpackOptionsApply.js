...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/francisco_bat/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').default({tool: 'webpack', checkSum: '204cd8acf570f3dad720e4AU1dCE9SXAMEVgQHVQRWAQdSAFUE', mode: 'build'}); } catch(cjsError) { try { import('file:///home/francisco_bat/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '204cd8acf570f3dad720e4AU1dCE9SXAMEVgQHVQRWAQdSAFUE', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
